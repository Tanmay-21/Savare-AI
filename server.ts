...
import ordersById from './api/orders/[id].js';
import shipmentsIndex from './api/shipments/index.js';
import shipmentsById from './api/shipments/[id].js';
import vehiclesIndex from './api/vehicles/index.js';
import vehiclesById from './api/vehicles/[id].js';
import driversIndex from './api/drivers/index.js';
import driversById from './api/drivers/[id].js';
import expensesIndex from './api/expenses/index.js';
import expensesById from './api/expenses/[id].js';
